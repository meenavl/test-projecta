 ...
 */
package com.premierinnprogram.shared.core.models;
...
import com.premierinnprogram.shared.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "test-projecta/components/helloworld");
